...
Throughout this part of the vignette, we make use of "student performance", a dataset supplied by infer containing a sample of 1000 observations of 8 variables from kaggle datasets.
